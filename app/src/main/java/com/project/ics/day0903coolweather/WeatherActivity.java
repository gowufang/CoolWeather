...
import com.project.ics.day0903coolweather.gson.Forecast;
import com.project.ics.day0903coolweather.gson.Weather;
import com.project.ics.day0903coolweather.service.AutoUpDateService;
...
//https://free-api.heweather.com/v5/weather?city=CN101190401&key=88bab21abcf943879231c43c60ab0684
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WeatherActivity.this,"获取天气信息失败 onFailured",
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.d("responseTextweather",weather.status);//kong ,说明有问题
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
